  ...
  return (
    ...
    <>
      <section className='productDetails'>
        <h1 className='productDetails__title'>Apple iPhone 11 Pro Max 64GB Gold (iMT9G2FS/A)</h1><div className='productDetails__mainDetails'>
          <div className='grid'>
            ...
            <div className='productDetails__additionalDetails__about grid__item--desktop-1-12'>
              ...
              <p className='productDetails__additionalDetails__about__paragraph'>A transformative triple‑camera system that adds tons of capability without complexity.
